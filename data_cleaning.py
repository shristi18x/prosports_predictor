...
#Get the Team Names from deliveries
teams_per_match = deliveries.groupby('id')[['batting_team', 'bowling_team']].first().reset_index()

#Calculate the Target Score from the 1st Innings
...
#filter both batting and bowling columns
...
#calculating wickets through new players on strike-nonstrike
...
#Average stats across all years
